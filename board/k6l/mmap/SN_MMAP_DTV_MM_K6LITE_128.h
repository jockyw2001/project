...
#define E_LX_MEM_LEN                                           0x0006B00000
#define E_LX_MEM_MEMORY_TYPE                                   (MIU0 | TYPE_NONE | UNCACHE | TYPE_NONE)
#define E_LX_MEM_CMA_HID                                       0

/* E_EMAC_MEM   */
#define E_EMAC_MEM_LAYER                                       0
#define E_EMAC_MEM_AVAILABLE                                   0x0007700000
#define E_EMAC_MEM_ADR                                         0x0007700000  //Alignment 0x01000
...
#define MMAP_COUNT                                             0x000000000D

#define TEST_4K_ALIGN                   1

/* CHK_VALUE = 2834949985 */