...
//MI_OD_RET MI_OD_SetDetectWindow(OD_HANDLE odHandle, uint16_t lt_x, uint16_t lt_y, uint16_t rb_x, uint16_t rb_y);
...
//MI_OD_RET MI_OD_SetWindowEnable(OD_HANDLE odHandle, uint8_t col, uint8_t row, uint8_t bEnable);
//MI_OD_RET MI_OD_GetWindowEnable(OD_HANDLE odHandle, uint8_t col, uint8_t row, uint8_t *en);
