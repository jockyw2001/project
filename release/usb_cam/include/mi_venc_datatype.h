...
#define MI_VENC_MAX_CHN_NUM_PER_MODULE (16)

//max supported channel number. But the number would be limited by each module.
#define VENC_MAX_CHN_NUM    (64) //from SPEC
...
/*
#define MI_VENC_Mpeg4ePackType_e MI_VENC_H264eNaluType_e
#define MI_VENC_H264eRefType_e   MI_VENC_H265eNaulType_e
#define MI_VENC_H265eRefType_e   MI_VENC_H265eNaulType_e
#define MI_VENC_StreamInfoMpeg4_t MI_VENC_StreamInfoH264_t
#define MI_VENC_AttrMpeg4_t      MI_VENC_AttrH264_t
#define MI_VENC_PayloadType_e    MI_VENC_ModType_e
#define MI_VENC_ParamMjpegCbr_t  MI_VENC_ParamH264Cbr_t
#define MI_VENC_ParamMpeg4Cbr_t  MI_VENC_ParamH264Cbr_t
#define MI_VENC_ParamMpeg4Vbr_t  MI_VENC_ParamH264Vbr_t
#define MI_VENC_ParamMjpegVbr_t  MI_VENC_ParamH264Vbr_t
...
typedef union MI_VENC_DataType_s
{
    ...
    //MI_VENC_Mpeg4ePackType_e eMPEG4EType; //not defined yet
...
typedef struct MI_VENC_Stream_s
{
    ...
    union
    {
        ...
        //MI_VENC_StreamInfoMpeg4_t stMpeg4Info; //not defined yet
...
{
    MI_VENC_ModType_e eType; //was MI_VENC_PayloadType_e eType;
    union
    {
        MI_VENC_AttrH264_t stAttrH264e;
        MI_VENC_AttrMjpeg_t stAttrMjpeg;
        MI_VENC_AttrJpeg_t stAttrJpeg;
        //MI_VENC_AttrMpeg4_t stAttrMpeg4; //not defined yet
...
typedef struct MI_VENC_ParamH264IntraPred_s
{
    ...
    MI_U32 constrained_intra_pred_flag;     //special naming for CODEC ISO SPEC.
    MI_BOOL bIpcmEn;
...
typedef struct MI_VENC_RcParam_s
{
    ...
    union
    {
        ...
        //MI_VENC_ParamMjpegCbr_t stParamMjpegCbr; //not defined yet
        //MI_VENC_ParamMjpegVbr_t stParamMjpegVbr; //not defined yet
        //MI_VENC_ParamMpeg4Cbr_t stParamMpeg4Cbr; //not defined yet
        //MI_VENC_ParamMpeg4Vbr_t stParamMpeg4Vbr; //not defined yet
