...
MI_S32 MI_SYS_ChnInputPortGetPABuf (MI_SYS_ChnPort_t *pstChnPort ,MI_SYS_BufConf_t *pstBufConf, MI_SYS_BufInfo_t *pstBufInfo , MI_SYS_BUF_HANDLE *pBufHandle , MI_S32 s32TimeOutMs);
...
MI_S32 MI_SYS_ChnOutputPortCopyToUsr (MI_SYS_ChnPort_t *pstChnPort,MI_SYS_BufInfo_t *pstBufInfo ,MI_SYS_BUF_HANDLE *pBufHandle);

MI_S32 MI_SYS_ChnOutputPortGetPABuf (MI_SYS_ChnPort_t *pstChnPort,MI_SYS_BufInfo_t *pstBufInfo ,MI_SYS_BUF_HANDLE *pBufHandle);
