...
#define _DRV_SYSTEM_H_
                                ...
                                || defined(CONFIG_MSTAR_KAYLA) || defined(CONFIG_MSTAR_KRATOS)
...
#elif defined(CONFIG_MSTAR_EINSTEIN) || defined(CONFIG_MSTAR_NAPOLI) || defined(CONFIG_MSTAR_MALDIVES) || defined(CONFIG_MSTAR_MACAN) || defined(CONFIG_MSTAR_MUSTANG)
//Fix me!!Needs to be reivewed!!
#define REG_ADDR(addr)                         (*((volatile U16*)(0xFD200000 + (addr << 1))))
#define REG_CKG_AEONTS0                         0x3360
#define AEON_CLK_ENABLE                         0x0000 //CLK 216MHz
...
#elif defined(CONFIG_MSTAR_K7U_CA53)
        #include <include/mstar/mstar_chip.h>

#elif defined(CONFIG_MSTAR_K6Lite)
	#include <include/mstar/mstar_chip.h>

#elif defined(CONFIG_MSTAR_K7U_CA7)
        #include <include/mstar/mstar_chip.h>
...
#elif defined(CONFIG_MSTAR_KYOTO)
#define ARM_MIU0_BUS_BASE                      0x20000000UL
#define ARM_MIU1_BUS_BASE                      0xA0000000UL
#define ARM_MIU2_BUS_BASE                      0xFFFFFFFFUL
#define ARM_MIU3_BUS_BASE                      0xFFFFFFFFUL
...
#elif defined(CONFIG_ARCH_INFINITY2)///TODO:Fix me!!Needs to be reivewed!!
...
#else//add this for bring up other chip
     #error unknown chip!!
...
#elif defined(CONFIG_ARCH_INFINITY2)
    #define MS_MIU_INTERVAL 0x80000000
