...
#define INT_FIQ_63_FIQ_FRM_PM               (GIC_SPI_MS_FIQ_START + 63) //	gic	159	spi	127
...
#define GPIO_0  (PM_GPIO_INT_START + 0) //pm_sleep_gpio0
#define GPIO_1  (PM_GPIO_INT_START + 1)
#define GPIO_2  (PM_GPIO_INT_START + 2)
#define GPIO_3  (PM_GPIO_INT_START + 3)
#define GPIO_4  (PM_GPIO_INT_START + 4)
#define GPIO_5  (PM_GPIO_INT_START + 5)
#define GPIO_6  (PM_GPIO_INT_START + 6)
#define GPIO_7  (PM_GPIO_INT_START + 7)
#define GPIO_8  (PM_GPIO_INT_START + 8)
#define GPIO_9  (PM_GPIO_INT_START + 9)
#define GPIO_10 (PM_GPIO_INT_START + 10)
#define GPIO_11 (PM_GPIO_INT_START + 11)
#define GPIO_12 (PM_GPIO_INT_START + 12)
#define GPIO_13 (PM_GPIO_INT_START + 13)
#define GPIO_14 (PM_GPIO_INT_START + 14)
#define GPIO_15 (PM_GPIO_INT_START + 15) //pm_sleep_gpio15
#define GPIO_16 (PM_GPIO_INT_START + 16)
#define GPIO_17 (PM_GPIO_INT_START + 17)
#define GPIO_18 (PM_GPIO_INT_START + 18)
#define GPIO_19 (PM_GPIO_INT_START + 19) //pm_sleep_gpio19
#define GPIO_20_IR  (PM_GPIO_INT_START + 20)
//#define GPIO_21_UART_RX (PM_GPIO_INT_START + 21) //?? check ??
#define GPIO_22_CEC (PM_GPIO_INT_START + 22)
//#define GPIO_23_un_connect  (PM_GPIO_INT_START + 23)
#define GPIO_24_SPI_CZ  (PM_GPIO_INT_START + 24)
#define GPIO_25_SPI_CK  (PM_GPIO_INT_START + 25)
#define GPIO_26_SPI_DI  (PM_GPIO_INT_START + 26)
#define GPIO_27_SPI_DO  (PM_GPIO_INT_START + 27)
...
//#define GPIO_67_PAD_PM_HDMI_CEC (PM_GPIO_INT_START + 67)
//#define GPIO_68_PAD_PM_SPI_WPZ  (PM_GPIO_INT_START + 68)
//#define GPIO_69_PAD_PM_SPI_HOLDZ    (PM_GPIO_INT_START + 69)
//#define GPIO_70_PAD_PM_SPI_RSTZ (PM_GPIO_INT_START + 70)
//#define GPIO_71_PAD_PM_SD_CDZ	    (PM_GPIO_INT_START + 71)
#define GPIO_72_PAD_VID0    (PM_GPIO_INT_START + 72)          //279
#define GPIO_73_PAD_VID1    (PM_GPIO_INT_START + 73)          //280
#define GPIO_74_PAD_LED0    (PM_GPIO_INT_START + 74)          //281
#define GPIO_75_PAD_LED1    (PM_GPIO_INT_START + 75)          //282
#define GPIO_76_PAD_PM_SPI_CZ1  (PM_GPIO_INT_START + 76)
//#define GPIO_77_PAD_PM_SPI_CZ2  (PM_GPIO_INT_START + 77)
#define GPIO_78_PAD_PM_SD30_CDZ (PM_GPIO_INT_START + 78) //277
#define GPIO_79_PAD_PM_SD20_CDZ (PM_GPIO_INT_START + 79) //278
